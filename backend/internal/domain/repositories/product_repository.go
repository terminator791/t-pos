...
type ProductRepository interface {
	...
	GetByShopIDs(ctx context.Context, shopIDs []uuid.UUID) ([]*entities.Product, error)
	...
	GetLowStockProductsByShopIDs(ctx context.Context, shopIDs []uuid.UUID) ([]*entities.Product, error)
